...
//Function to cancel booking and release seats of show after 10 minutes of booking created if payment is not made
  ...
  async ({event, step}) => {
    ...
    await sendEmail({
      ...
      body: `<div style="font-family: Arial, sans-serif; line-height: 1.5;">
                ...
                <p>Enjoy the show! 🍿</p>
                <p>Thanks for booking with us!<br/>-Ahmed Omran</p>
              </div>`,
    });
  }
);
...
//Send notification when a new show is added
